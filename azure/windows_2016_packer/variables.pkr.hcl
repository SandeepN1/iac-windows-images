...
variable "az_gallery_image_name" {
  type        = string
  description = "Shared Image Gallery Image Name"
  default     = ""
}

variable "az_gallery_timeout" {
  type        = string
  description = "How long to wait for an image to be published to the shared image gallery before timing out"
  default     = "60m"
}
